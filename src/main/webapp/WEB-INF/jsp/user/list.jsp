...
<script language="javascript" src="${pageContext.request.contextPath}/js/plugs/jquery-checkbox.js"></script>
<script language="javascript" src="${pageContext.request.contextPath}/js/user_list.js"></script>
<script language="javascript" src="${pageContext.request.contextPath}/js/frame/jquery-ztree-2.5.js"></script>
